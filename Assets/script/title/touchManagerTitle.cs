...
public class touchManagerTitle : MonoBehaviour {
	...
	void GetDirection(){
		...
		switch(MainCameraTitle.current_view){
		case (int)MainCameraTitle.View.A:
			direction = directionX;
			Direct1 = "right";
			Direct2 = "left";
			break;
		case (int)MainCameraTitle.View.C:
			direction = directionX;
			Direct1 = "left";
			Direct2 = "right";
			break;
		case (int)MainCameraTitle.View.B:
			direction = directionZ;
			Direct1 = "right";
			Direct2 = "left";
			break;
		case (int)MainCameraTitle.View.D:
			direction = directionZ;
			Direct1 = "left";
			Direct2 = "right";
			break;
